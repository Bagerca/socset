...
export const ProfileView = {
    html: `
        <div class="profile-container">
            ...
            <div id="profileComposeBox" style="padding: 24px; border-top: 1px solid var(--border-color);">
        ...
        <div id="settingsModal" class="modal-overlay">
            <div class="modal-content" style="max-width: 600px;">
                ...
                <div class="modal-body" style="gap: 16px;">
                    ...
                    <!-- КНОПКА ВЫХОДА И СОХРАНЕНИЯ -->
                    <div style="border-top: 1px solid var(--border-color); margin-top: 16px; padding-top: 16px;">
                        <button id="logoutBtn" class="btn-post" style="width: 100%; background: rgba(255, 69, 58, 0.15); color: var(--danger); border: 1px solid rgba(255, 69, 58, 0.3);">
