    ...
    html: `
        <div class="game-page-container">
            <div class="game-page-hero" id="gameHero">
                <div class="gp-hero-bg-wrapper"><img id="gameHeroBg" src="" class="gp-hero-bg"></div>
                <div class="gp-hero-overlay"></div>
                <div class="gp-hero-content">
                    <img id="gameHeroCover" src="" class="gp-cover">
                    <div class="gp-info">
                        <div class="gp-title-area"><h1 id="gameHeroTitle" class="gp-title">Loading...</h1></div>
            ...
            <div class="gp-body-layout">
                <div class="gp-main-column">
                    ...
                    <div class="gp-section">
                        ...
                        <div id="gameComposeContainer" style="margin-bottom: 24px; margin-top: 12px;"></div>
                ...
                <div class="gp-sidebar-column">
                    <div class="gp-side-block">
                        <div class="gp-meta-list">
                            <div class="gp-meta-item"><span class="gp-meta-label">Дата выхода</span><span class="gp-meta-value" id="gameHeroDate">...</span></div>
                            <div class="gp-meta-item"><span class="gp-meta-label">Разработчик</span><span class="gp-meta-value" id="gameHeroDev">...</span></div>
                            <div class="gp-meta-item"><span class="gp-meta-label">Издатель</span><span class="gp-meta-value" id="gameHeroPub">...</span></div>
                        </div>
                    </div>
                    <div class="gp-side-block"><h4 class="gp-side-title">Жанры и теги</h4><div id="gameSideTags" class="gp-all-tags"></div></div>
                    <div class="gp-side-block" id="gameMusicBlock" style="display:none;"><h4 class="gp-side-title"><i class="fa-solid fa-music"></i> Саундтрек</h4><div id="gameMusicList" class="m-tracks-container compact"></div></div>
                </div>
            </div>
        </div>
