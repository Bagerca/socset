...
export class MessageBuilder {
    /**
     * Генерирует аудио-плеер. 
     * Если isVoice = true, применяется BEM-модификатор для компактного дизайна.
     */
    static buildAudioPlayer(url, waveformData, isVoice = false) {
        ...
        const voiceClass = isVoice ? 'cycle-audio-player--voice' : '';
        
        return `
            <div class="cycle-audio-player ${voiceClass}">
